...
export const V1_MAX_BUNDLE_FILES = 512;
export const V1_MAX_BUNDLE_MANIFEST_BYTES = 512 * 1024;
export const V1_MAX_BUNDLE_PATH_BYTES = 1024;
...
export const V1_POLICY = Object.freeze({
  ...
  maxBundleFiles: V1_MAX_BUNDLE_FILES,
  maxBundleManifestBytes: V1_MAX_BUNDLE_MANIFEST_BYTES,
  maxBundlePathBytes: V1_MAX_BUNDLE_PATH_BYTES,
