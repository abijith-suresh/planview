...
Private daemon lifecycle implementation for Planview. It is bundled into the
published CLI and is not a published package API.
...
secret for lifecycle endpoints.
